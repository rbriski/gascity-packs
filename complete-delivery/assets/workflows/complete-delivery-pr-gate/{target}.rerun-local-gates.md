...
and close with a non-pass outcome. From the launcher worktree (not an arbitrary
runner directory), invoke
`.gc/scripts/checks/delivery-local-gates.sh` with this claimed
