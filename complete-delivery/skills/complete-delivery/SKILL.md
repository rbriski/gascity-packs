...
description: Carry authorized software work from product intent through implementation, repository-native tests, independent review, CodeRabbit and GitHub checks, fixes, protected merge, deployment, production verification, and a living HTML report. Use when the user says “complete this work,” “take this all the way,” “ship it,” “deploy it,” or otherwise defines done as more than producing code or a pull request.
---
...
2. Confirm that the rig has a Complete Delivery profile for its exact local
   gates, required checks, CodeRabbit posture, deployment, smoke test, and
...
- CodeRabbit completed on that head with no live unresolved findings;
